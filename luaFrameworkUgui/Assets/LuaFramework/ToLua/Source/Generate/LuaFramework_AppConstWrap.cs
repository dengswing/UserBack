...
public class LuaFramework_AppConstWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("VersionFile", get_VersionFile, null);
		...
		L.RegVar("PlatformFile", get_PlatformFile, null);
		L.EndClass();
	}
	...
	{
		LuaDLL.lua_pushstring(L, LuaFramework.AppConst.VersionFile);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_PlatformFile(IntPtr L)
	{
		LuaDLL.lua_pushstring(L, LuaFramework.AppConst.PlatformFile);
		return 1;
	}
