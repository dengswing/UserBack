    ...
    public class JsonClassGenerator : IJsonClassGeneratorConfig
    {
        ...
        public void GenerateClasses()
        {
            ...
            if (writeToDisk)
            {
                ...
                if (writeToDisk && !NoHelperClass && ExplicitDeserialization) File.WriteAllBytes(Path.Combine(TargetFolder, "JsonClassHelper.cs"), Assets.JsonStruct.JsonCSharpClassGeneratorLib.Properties.Resources.JsonClassHelper);
                if (SingleFile)
                {
